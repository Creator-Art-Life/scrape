...
import DeleteCredentialDialog from "./_components/DeleteCredentialsDilog";
    ...
    <div className="flex flex-1 flex-col h-full">
      ...
      <div className="h-full py-6 space-y-8">
        <Alert>
          ...
          <AlertDescription>
            All information is securely ecrypted, ensuring your data remains
            safe
          </AlertDescription>
        </Alert>
  ...
  if (!credentials) {
    return (
      <div>
        ...
        <p className="text-muted-foreground">Your credentials not found</p>
      </div>
    );
  }
